...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            System.Console.WriteLine("##################################External Login##########");
        ...
        {
            System.Console.WriteLine("############################################ ExternalLoginCallback");
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            {
                await _signInManager.SignOutAsync(); //eu adicionei
                // delete local authentication cookie
                await HttpContext.SignOutAsync();
System.Console.WriteLine("deletando cookie=============================");
...
System.Console.WriteLine("fim deletando cookie=========================");
